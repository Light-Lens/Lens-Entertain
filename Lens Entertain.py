...
class Entertain(QMainWindow):
	def __init__(self):
		...
		self.setGeometry(250, 250, 400, 175)
		self.ChangeColors()
		...
		self.PlayerSlider.setFocusPolicy(Qt.NoFocus)
		self.PlayerSlider.setRange(0, 0)
		self.PlayerSlider.sliderMoved.connect(self.SetPosition)
		...
		ControlArea.addWidget(self.PlayerSlider)
